    ...
    return (
        <div className="container-fluid border px-5 py-3">
            ...
            <div className="row pt-4">
                ...
                <select name="day" id="" className="form-select w-25 text-secondary" placeholder="select">
                    <option value="none">Select</option>
                    {
                        days.map(value => <option value={value} key={value}>{value}</option>)
                    }
                </select>
                <select name="date" id="" className="form-select w-25 ms-2 text-secondary" placeholder="select">
                    <option value="none">Select</option>
                    {
                        months.map(value => <option value={value} key={value}>{value}</option>)
                    }
                </select>
                <select name="year" id="" className="form-select w-25 ms-2 text-secondary" placeholder="select">
                    <option value="none">Select</option>
                    {
            ...
            <div className="row mt-4">
                ...
                <select name="gender" id="" className="form-select w-25  text-secondary">
